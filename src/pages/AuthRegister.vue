    ...
    <q-page class="flex flex-center">
        <div class="row" style="width:100%">
            ...
            <div class="col-10 col-sm-8 col-md-6" style="max-width:400px">
                <span class="row text-h4"><b>Criar a sua Conta</b></span>
...
export default {
  ...
  methods: {
    goToLogin () {
      this.$router.push({ path: '/auth/login', query: Object.assign({}, this.$route.query) })
    },
    irParaSenha () {
      const self = this
      ...
      self.$router.push({ path: '/auth/register/email', query: Object.assign({}, self.$route.query) })
    },
    logar () {
      const self = this
      self.$refs.email.validate()
